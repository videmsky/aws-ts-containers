 ...
 * ```
 */
export declare function getResourceCollectionOutput(args: GetResourceCollectionOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetResourceCollectionResult>;
/**
 * A collection of arguments for invoking getResourceCollection.
 */
